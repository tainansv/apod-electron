...
class AppUpdater extends (_events || _load_events()).EventEmitter {
    ...
    isStagingMatch(updateInfo) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const stagingUserId = yield _this.stagingUserIdPromise;
    ...
    doCheckForUpdates() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            if (_this3.clientPromise == null) {
                _this3.clientPromise = _this3.loadUpdateConfig().then(function (it) {
                    return _this3.createClient(it);
                });
            }
            const client = yield _this3.clientPromise;
            const stagingUserId = yield _this3.stagingUserIdPromise;
