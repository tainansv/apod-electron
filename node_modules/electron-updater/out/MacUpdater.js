        ...
        const downloadRequest = this.httpExecutor.doRequest((0, (_electronBuilderHttp || _load_electronBuilderHttp()).configureRequestOptions)({
            ...
            if (this.listenerCount((_main || _load_main()).DOWNLOAD_PROGRESS) > 0) {
                ...
                if (contentLength != null) {
                    streams.push(new (_electronBuilderHttp || _load_electronBuilderHttp()).ProgressCallbackTransform(parseInt(contentLength, 10), new (_electronBuilderHttp || _load_electronBuilderHttp()).CancellationToken(), it => this.emit((_main || _load_main()).DOWNLOAD_PROGRESS, it)));
                }
            }
