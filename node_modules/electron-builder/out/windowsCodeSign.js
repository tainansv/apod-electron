...
let spawnSign = (() => {
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (options, inputPath, outputPath, hash, nest) {
        ...
        return yield (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)((yield getToolPath()), args, { timeout: 120 * 1000 });
    });
...
function getSignVendorPath() {
    ...
    return (0, (_binDownload || _load_binDownload()).getBinFromGithub)("winCodeSign", "1.8.0", "NWd9hH9MuAgJFzhVzW1bpPplDTBwwYfPUg2skeEri2zp4PFcibbUWPvqUTv+Xnyg0MCdpsrVF1GMIHZGT8wMRw==");
}
...
/** @internal */
function isOldWin6() {
    const winVersion = (0, (_os || _load_os()).release)();
