...
class PkgTarget extends (_core || _load_core()).Target {
    ...
    build(appPath, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("productbuild", ["--synthesize", "--component", appPath, _this.installLocation, distInfoFile], {
                cwd: appOutDir
            });
            ...
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(distInfo);
