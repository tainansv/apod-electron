...
class AppImageTarget extends (_core || _load_core()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            (0, (_log || _load_log()).log)(`Building AppImage for arch ${(_core || _load_core()).Arch[arch]}`);
            const packager = _this.packager;
            // https://github.com/electron-userland/electron-builder/issues/775
            const resultFile = _path.join(_this.outDir, packager.computeSafeArtifactName("AppImage", arch, false));
            ...
            yield new (_bluebirdLst2 || _load_bluebirdLst2()).default(function (resolve, reject) {
                const rd = (0, (_fsExtraP || _load_fsExtraP()).createReadStream)(_path.join(appImagePath, arch === (_core || _load_core()).Arch.ia32 ? "32" : "64", "runtime"));
                rd.on("error", reject);
