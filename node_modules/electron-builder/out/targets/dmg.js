...
class DmgTarget extends (_core || _load_core()).Target {
    ...
    computeDmgOptions() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (oldPosition != null) {
                (0, (_log || _load_log()).warn)("dmg.window.position is deprecated, please use dmg.window instead");
            }
            if (oldSize != null) {
                (0, (_log || _load_log()).warn)("dmg.window.size is deprecated, please use dmg.window instead");
            }
            if (oldIconSize != null) {
