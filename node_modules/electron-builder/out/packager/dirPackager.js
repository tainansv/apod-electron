...
let unpack = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, out, platform, options) {
        ...
        if (dist == null) {
            ...
            (0, (_log || _load_log()).log)(`Copying Electron from "${source}" to "${destination}"`);
            yield (0, (_fsExtraP || _load_fsExtraP()).emptyDir)(out);
            yield (0, (_fs || _load_fs()).copyDir)(source, destination, null, null, (_fs || _load_fs()).DO_NOT_USE_HARD_LINKS);
        }
        if (platform === "linux") {
