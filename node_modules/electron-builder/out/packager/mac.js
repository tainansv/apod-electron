...
let createApp = exports.createApp = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, appOutDir, asarIntegrity) {
            ...
            appPlist.CFBundleDocumentTypes = yield (_bluebirdLst2 || _load_bluebirdLst2()).default.map(fileAssociations, (() => {
                var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (fileAssociation) {
                    ...
                    if (customIcon != null) {
                        ...
                        yield (0, (_fs || _load_fs()).copyOrLinkFile)(customIcon, _path.join(resourcesPath, iconFile));
                    }
                    const result = {
        ...
        if (icon != null) {
            promises.push((0, (_fs || _load_fs()).unlinkIfExists)(_path.join(resourcesPath, oldIcon)));
            promises.push((0, (_fs || _load_fs()).copyFile)(icon, _path.join(resourcesPath, appPlist.CFBundleIconFile)));
        }
