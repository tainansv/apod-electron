...
let installAppDeps = exports.installAppDeps = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (args) {
        ...
        const results = yield (_bluebirdLst2 || _load_bluebirdLst2()).default.all([(0, (_electronBuilderUtil || _load_electronBuilderUtil()).computeDefaultAppDirectory)(projectDir, (0, (_electronBuilderUtil || _load_electronBuilderUtil()).use)(config.directories, function (it) {
            return it.app;
        })), muonVersion == null ? (0, (_config || _load_config()).getElectronVersion)(config, projectDir) : (_bluebirdLst2 || _load_bluebirdLst2()).default.resolve(muonVersion)]);
...
if (process.mainModule === module) {
    (0, (_log || _load_log()).warn)("Please use as subcommand: electron-builder install-app-deps");
