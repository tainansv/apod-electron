        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (!hasMas || targets.length > 1) {
                ...
                nonMasPromise = (prepackaged ? (_bluebirdLst2 || _load_bluebirdLst2()).default.resolve() : _this2.doPack(outDir, _path.dirname(appPath), _this2.platform.nodeName, arch, _this2.platformSpecificBuildOptions, targets)).then(function () {
                    ...
                    return _this2.packageInDistributableFormat(appPath, (_core || _load_core()).Arch.x64, targets, postAsyncTasks);
                });
            }
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if ((0, (_electronBuilderUtil || _load_electronBuilderUtil()).isPullRequest)()) {
                if (process.env.CSC_FOR_PULL_REQUEST === "true") {
                    (0, (_log || _load_log()).warn)(buildForPrWarning);
                } else {
                    // https://github.com/electron-userland/electron-builder/issues/1524
                    (0, (_log || _load_log()).warn)("Current build is a part of pull request, code signing will be skipped." + "\nSet env CSC_FOR_PULL_REQUEST to true to force code signing." + `\n${buildForPrWarning}`);
                    return;
                }
            }
            ...
            let identity = yield (0, (_codeSign || _load_codeSign()).findIdentity)(isDevelopment ? "Mac Developer" : isMas ? "3rd Party Mac Developer Application" : "Developer ID Application", isMas ? masQualifier : qualifier, keychainName);
            if (identity == null) {
            ...
            yield (0, (_log || _load_log()).task)(`Signing app (identity: ${identity.hash} ${identity.name})`, _this3.doSign(signOptions));
            if (masOptions != null) {
                ...
                _this3.dispatchArtifactCreated(pkg, null, (_core || _load_core()).Arch.x64, _this3.computeSafeArtifactName("pkg"));
            }
        })();
    }
