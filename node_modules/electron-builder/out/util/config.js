...
exports.validateConfig = exports.getElectronVersion = exports.computeFinalConfig = exports.loadConfig = exports.doLoadConfig = undefined;
...
let loadConfig = exports.loadConfig = (() => {
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (projectDir, packageMetadata) {
        for (const configFile of ["electron-builder.yml", "electron-builder.yaml", "electron-builder.json", "electron-builder.json5", "electron-builder.toml"]) {
            const data = yield (0, (_promise || _load_promise()).orNullIfFileNotExist)(doLoadConfig(_path.join(projectDir, configFile), projectDir));
            if (data != null) {
                return data;
            }
        }
        ...
        if ((yield (0, (_fs || _load_fs()).statOrNull)(_path.join(projectDir, "app.asar"))) != null) {
...
let computeFinalConfig = exports.computeFinalConfig = (() => {
    ...
    return function computeFinalConfig(_x5, _x6, _x7, _x8) {
