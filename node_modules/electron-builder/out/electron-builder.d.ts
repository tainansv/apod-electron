...
declare module "electron-builder/out/packagerApi" {
  ...
  import { Arch, Platform, SourceRepositoryInfo, Target } from "electron-builder/out/core"
...
declare module "electron-builder/out/platformPackager" {
  ...
  export abstract class PlatformPackager<DC extends PlatformSpecificBuildOptions> {
    ...
    getElectronDestDir(appOutDir: string): string
...
declare module "electron-builder/out/targets/nsis" {
  ...
  export class NsisTarget extends Target {
    ...
    private writeCustomLangFile(data)
...
declare module "electron-builder/out/publish/PublishManager" {
  ...
  export class PublishManager implements PublishContext {
    ...
    private getOrCreatePublisher(publishConfig, buildInfo)
    cancelTasks(): void
...
declare module "electron-builder/out/targets/WebInstallerTarget" {
  import { WinPackager } from "electron-builder/out/winPackager"
  import { AppPackageHelper, NsisTarget } from "electron-builder/out/targets/nsis"
...
declare module "electron-builder/out/packager" {
  ...
  import { AfterPackContext, Config, Metadata } from "electron-builder/out/metadata"
  import { ArtifactCreated, BuildInfo, PackagerOptions } from "electron-builder/out/packagerApi"
...
declare module "electron-builder" {
  ...
  export { PackagerOptions, ArtifactCreated, BuildInfo } from "electron-builder/out/packagerApi"
  ...
  export { Metadata, Config, AfterPackContext, MetadataDirectories, Protocol, FileAssociation, PlatformSpecificBuildOptions, AuthorMetadata, RepositoryInfo, AsarOptions, FilePattern } from "electron-builder/out/metadata"
